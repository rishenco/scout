...
import type { GetApiProfilesData, GetApiProfilesResponse, GetApiProfilesError, PostApiProfilesData, PostApiProfilesResponse, PostApiProfilesError, DeleteApiProfilesByProfileIdData, DeleteApiProfilesByProfileIdResponse, DeleteApiProfilesByProfileIdError, GetApiProfilesByProfileIdData, GetApiProfilesByProfileIdResponse, GetApiProfilesByProfileIdError, PutApiProfilesByProfileIdData, PutApiProfilesByProfileIdError, PostApiProfilesByProfileIdJumpstartData, PostApiProfilesByProfileIdJumpstartResponse, PostApiProfilesByProfileIdJumpstartError, PostApiDetectionsListData, PostApiDetectionsListResponse, PostApiDetectionsListError, PutApiDetectionsTagsData, PutApiDetectionsTagsResponse, PutApiDetectionsTagsError, PostApiAnalyzeData, PostApiAnalyzeResponse, PostApiAnalyzeError, GetApiSourcesRedditSubredditsData, GetApiSourcesRedditSubredditsResponse, GetApiSourcesRedditSubredditsError, PostApiSourcesRedditSubredditsBySubredditAddProfilesData, PostApiSourcesRedditSubredditsBySubredditAddProfilesResponse, PostApiSourcesRedditSubredditsBySubredditAddProfilesError, PostApiSourcesRedditSubredditsBySubredditRemoveProfilesData, PostApiSourcesRedditSubredditsBySubredditRemoveProfilesResponse, PostApiSourcesRedditSubredditsBySubredditRemoveProfilesError, GetApiSourcesRedditSubredditsWithProfileData, GetApiSourcesRedditSubredditsWithProfileResponse, GetApiSourcesRedditSubredditsWithProfileError, GetApiStatisticsByProfileIdData, GetApiStatisticsByProfileIdResponse, GetApiStatisticsByProfileIdError } from './types.gen';
...
export const deleteApiProfilesByProfileId = <ThrowOnError extends boolean = false>(options: Options<DeleteApiProfilesByProfileIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiProfilesByProfileIdResponse, DeleteApiProfilesByProfileIdError, ThrowOnError>({
        security: [
            {
                scheme: 'basic',
                type: 'http'
...
export const getApiProfilesByProfileId = <ThrowOnError extends boolean = false>(options: Options<GetApiProfilesByProfileIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiProfilesByProfileIdResponse, GetApiProfilesByProfileIdError, ThrowOnError>({
        security: [
            {
                scheme: 'basic',
                type: 'http'
...
export const putApiProfilesByProfileId = <ThrowOnError extends boolean = false>(options: Options<PutApiProfilesByProfileIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, PutApiProfilesByProfileIdError, ThrowOnError>({
        security: [
            {
                scheme: 'basic',
                type: 'http'
...
export const postApiProfilesByProfileIdJumpstart = <ThrowOnError extends boolean = false>(options: Options<PostApiProfilesByProfileIdJumpstartData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiProfilesByProfileIdJumpstartResponse, PostApiProfilesByProfileIdJumpstartError, ThrowOnError>({
        security: [
            {
                scheme: 'basic',
                type: 'http'
...
export const getApiStatisticsByProfileId = <ThrowOnError extends boolean = false>(options: Options<GetApiStatisticsByProfileIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiStatisticsByProfileIdResponse, GetApiStatisticsByProfileIdError, ThrowOnError>({
        security: [
            {
                scheme: 'basic',
                type: 'http'
